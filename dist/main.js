...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ businessHours)\n/* harmony export */ });\nfunction businessHours() {\n  var openingHours = document.querySelector(\"[data-week]\");\n  var daysWeek = openingHours.dataset.week.split(\",\").map(Number);\n  var hourWeek = openingHours.dataset.schedule.split(\",\").map(Number);\n  var dateNow = new Date();\n  var dayNow = dateNow.getDay();\n  var hourNow = dateNow.getHours();\n  var weekOpen = daysWeek.indexOf(dayNow) !== -1;\n  var hourOpen = hourNow >= hourWeek[0] && hourNow < hourWeek[1];\n  if (weekOpen && hourOpen) {\n    openingHours.classList.add(\"open\");\n  }\n  ;\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/business-hours.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ menuMobile)\n/* harmony export */ });\n/* harmony import */ var _outside_click_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outside-click.js */ \"./js/modules/outside-click.js\");\n\nfunction menuMobile() {\n  var btnMenu = document.querySelector(\"[data-menu='button']\");\n  var listMenu = document.querySelector(\"[data-menu= 'list']\");\n  var events = [\"click\", \"touchstart\"];\n  function toggleMenu() {\n    [listMenu, btnMenu].forEach(function (item) {\n      item.classList.toggle(\"active\");\n    });\n    (0,_outside_click_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(listMenu, [\"click\", \"touchstart\"], function () {\n      listMenu.classList.remove(\"active\");\n      btnMenu.classList.remove(\"active\");\n    });\n  }\n  if (btnMenu) {\n    events.forEach(function (event) {\n      return btnMenu.addEventListener(event, toggleMenu);\n    });\n  }\n  ;\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/menu-mobile.js?");
